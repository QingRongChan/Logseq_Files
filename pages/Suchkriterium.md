...
-
- Test query
- {{query (and (property materialkomplexität [[W5_Kombination von unterschiedlichen Materialien , Hart-Weich Kombination]]) (property Technology_Readiness_Level [[TL5]]))}}
  query-table:: false
-
-
-
